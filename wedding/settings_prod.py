...
DEBUG = False
ALLOWED_HOSTS = ['wedding-production-9b77.up.railway.app', 'wedding-production-9b77.up.railway.app/admin', 'wedding-production-9b77.up.railway.app/social-auth/login/facebook/']
# Database
